...
# clone of input with patterns separated for clarity
filename3 = "sim_input/inputclone.txt"
...
def generate_pattern_t(pl, bl):
    ...
    for counter in range(1, int(pl)+1):
        # call function that generates random binary numbers
        ina = randbin2(int(bl))
        # call function that generates random binary numbers
        inb = randbin2(int(bl))
        ...
        # format readable. same as input file but readable
        target3.write(ina + "	" + inb)
